...
#define RESET_GPIO_Port	                            LORA_RESET_GPIO_Port
#define RESET_Pin                                   LORA_RESET_Pin

#define NSS_GPIO_Port                               LORA_NSS_GPIO_Port
#define NSS_Pin                                     LORA_NSS_Pin

#define DIO0_GPIO_Port                              LORA_DIO0_GPIO_Port
